...
<div id="blocker" style="display: none">
	...
	<div class="modal" id="about-modal" style="display: none;">
		<a href="javascript:disable_modal()" class="modal-close">[x]</a>
		<p>Created by tehtmi (#1214057) <a href="mailto:kol@lethe.xyz">[contact]</a></p>
	...
	<div class="modal" id="changes-modal" style="display: none;">
		<a href="javascript:disable_modal()" class="modal-close">[x]</a>
		<h3>Changes</h3>
		<div style="overflow-y: auto; width: 100%; height: 100%; text-align: left; font-size: small;"><p>2020-06-12</p><ul>
...
<h2>Kingdom of Loathing diet calculator</h2>
	...
	<select id="semirares" onchange="settings_changed()">
		<option  value="0">No semirares</option>
...
<p><small><a href="javascript:about()">[about]</a> | <a href="javascript:changes()">[changes]</a> | Price data last updated: 2022-08-22</small></p>
